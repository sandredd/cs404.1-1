...
class PlagiarismDetectorTest(unittest.TestCase):
    def setUp(self):
        ...
        self.pd.add_search_text("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor "
    ...
    def test_plagiarized_across_sentences(self):
        self.assertTrue(self.pd.is_plagiarized("pariatur. Excepteur sint occaecat"))
        self.assertTrue(self.pd.is_plagiarized("pariatur Excepteur sint occaecat"))
