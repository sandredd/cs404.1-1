...
class ShortestPathTest(unittest.TestCase):
    ...
    def test_source_0(self):
        ...
        dist_to = [
            0, 14, 12, sys.maxsize, sys.maxsize, 8, 20, sys.maxsize,
    ...
    def test_source_1(self):
        ...
        dist_to = [
            sys.maxsize, 0, sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize,
    ...
    def test_source_2(self):
        ...
        dist_to = [
            sys.maxsize, sys.maxsize, 0, sys.maxsize, sys.maxsize, sys.maxsize,
            sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize,
            sys.maxsize
        ]
        self.check_graph(sp, has_path_to, dist_to)
    ...
    def test_source_3(self):
        ...
        dist_to = [
            sys.maxsize, sys.maxsize, sys.maxsize, 0, 4, 2, 17, sys.maxsize,
    ...
    def test_source_4(self):
        ...
        dist_to = [
            sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize, 0, 7, 13,
            sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize
        ]
        self.check_graph(sp, has_path_to, dist_to)
    ...
    def test_source_5(self):
        ...
        dist_to = [
            sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize, 0,
            sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize,
            sys.maxsize
        ]
        self.check_graph(sp, has_path_to, dist_to)
    ...
    def test_source_7(self):
        ...
        dist_to = [
            sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize,
            sys.maxsize, sys.maxsize, 0, 17, sys.maxsize, sys.maxsize,
            sys.maxsize
        ]
        self.check_graph(sp, has_path_to, dist_to)
    ...
    def test_source_8(self):
        ...
        dist_to = [
            sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize,
            sys.maxsize, sys.maxsize, sys.maxsize, 0, sys.maxsize, sys.maxsize,
            sys.maxsize
        ]
        self.check_graph(sp, has_path_to, dist_to)
    ...
    def test_source_9(self):
        ...
        dist_to = [
            sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize,
            sys.maxsize, sys.maxsize, sys.maxsize, sys.maxsize, 0, 19, 11
        ]
        self.check_graph(sp, has_path_to, dist_to)
